      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Check BPU</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><i class="fa fa-table"></i> List Check Budget B2</h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                  <i class="fas fa-minus"></i></button>
              </div>
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $key['pengajubpu'] ?></td>
                      <td><a href="<?php echo base_url()?>/dist/uploadbpu/<?php echo $key['fileupload']?>" target="_blank"><i class="fa fa-file"></i></a></td>
                      <td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-b2<?php echo $i; ?>"><i class="fa fa-edit"></i></button></td>
                    </tr>
                    <div class="modal" id="modal-b2<?php echo $i; ?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title">B2 - Check BPU #<?php echo $i++; ?></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><i class="fa fa-table"></i> List Check Budget Rutin</h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                  <i class="fas fa-minus"></i></button>
              </div>
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $key['pengajubpu'] ?></td>
                      <td><a href="<?php echo base_url()?>/dist/uploadbpu/<?php echo $key['fileupload']?>" target="_blank"><i class="fa fa-file"></i></a></td>
                      <td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-rutin<?php echo $i; ?>"><i class="fa fa-edit"></i></button></td>
                    </tr>
                    <div class="modal" id="modal-rutin<?php echo $i; ?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title">Rutin - Check BPU #<?php echo $i++; ?></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><i class="fa fa-table"></i> List Check Budget Non Rutin</h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                  <i class="fas fa-minus"></i></button>
              </div>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $i = 1;
                    foreach ($bpuunceknonrutin AS $key){
                    ?>
                    <tr>
                      <td><?php echo $i++ ?></td>
                      <td><?php echo $key['jenis'] ?></td>
                      ...
                      <td><?php echo $key['pengajubpu'] ?></td>
                      <td><a href="<?php echo base_url()?>/dist/uploadbpu/<?php echo $key['fileupload']?>" target="_blank"><i class="fa fa-file"></i></a></td>
                      <td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-nonrutin<?php echo $i; ?>"><i class="fa fa-edit"></i></button></td>
                    </tr>
                    <div class="modal" id="modal-nonrutin<?php echo $i; ?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 class="modal-title">Non Rutin - Check BPU #<?php echo $i++; ?></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
